...
class LoadingOverlay extends StatelessWidget {
  ...
  /// Optional secondary hint shown under [message] (e.g. explaining that a
  /// first on-device run can take a while so it doesn't read as frozen).
  final String? subMessage;

  /// If provided, a "Cancel" action is shown so the user isn't stuck staring
  /// at a spinner with no way out if something is taking too long.
